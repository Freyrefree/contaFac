...
function genera_pdf2($id, $datos){
  ...
  $datos->set("id_doc", addslashes(utf8_decode($id))); //para obtener el rfc del emisor
  ...
  $datos->set("id_pago", addslashes(utf8_decode($id))); //
  $res_com= $datos->select_complemento();
  while($row_com = mysqli_fetch_array($res_com, MYSQLI_ASSOC)){
    $uuid_factura=$row_com["folio_fiscal"];
  }


  $archivador2="../comprobantesPago/".$uuid_factura.".xml"; 
...
foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Receptor') as $Receptor){
  $r_rfc = $Receptor['Rfc']; 
  $rfc_recpetorCFDI=$Receptor['Rfc']; //facturacion 3.3
}


$noCertificado_origen="";
foreach ($xml->xpath('//cfdi:Comprobante') as $cfdiComprobante){ 
      $noCertificado_origen = $cfdiComprobante['NoCertificado']; 
}
...
$UUID_origen="";
$FechaTimbrado_origen="";
$selloCFD_origen="";
$noCertificadoSAT_origen="";
$tfd_version_origen="";
$selloSAT_origen="";

foreach ($xml->xpath('//t:TimbreFiscalDigital') as $tfd) {
   $selloCFD_origen = $tfd['SelloCFD']; 
   $FechaTimbrado_origen = $tfd['FechaTimbrado']; 
   $UUID_origen = $tfd['UUID']; 
   $noCertificadoSAT_origen = $tfd['NoCertificadoSAT']; 
   $tfd_version_origen = $tfd['Version']; 
   $selloSAT_origen = $tfd['SelloSAT']; 
}

$digitos="";
$digitos=substr($selloSAT_origen, -8);//obtener los ultimos digitos facturacion 3.3

$t="0.00";
$level = 'H';
$data = "https://verificacfdi.facturaelectronica.sat.gob.mx/default.aspx?re=".$e_rfc."&rr=".$rfc_recpetorCFDI."&tt=".$t."&id=".$UUID_origen."&fe=".$digitos;
...
// //para los totales finales
// $html_desc_debe .= '<tr>';
// $html_desc_debe .= '<td HEIGHT="" align="center" style="font-size:12px; border-top: 1px solid #ccc;  border-right: 1px solid #ccc;  ">'.$folio.'</td>';
// $html_desc_debe .= '<td HEIGHT="" align="center" style="font-size:12px; border-top: 1px solid #ccc;  border-right: 1px solid #ccc;  ">$ '.$total_factura.'</td>';
// $html_desc_debe .= '<td HEIGHT="" align="center" style="font-size:12px; border-top: 1px solid #ccc; border-right: 1px solid #ccc; ">$ '.$saldo_pendiente.'</td>'; 
// $html_desc_debe .= '<td HEIGHT="" align="center" style="font-size:12px; border-top: 1px solid #ccc; border-right: 1px solid #ccc; ">$ '.$monto_pagado.'</td>';   
...
// foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Impuestos') as $ImpuestosTrasladados){ 
foreach ($xml->xpath('//cfdi:Comprobante//cfdi:Complemento//pago10:Pagos//pago10:Pago//pago10:DoctoRelacionado') as $cfdiRelacionado){ 
      ...
      $metodo_pago=$cfdiRelacionado['MetodoDePagoDR'];
  ...
  <div style="width: 100%;  border-bottom: 0px solid #ccc;">
       ...
       <div style="width: 70%; border: 0px solid #ccc; border-radius:2pt; padding: 0pt; float: left;">
         <table style="border: 0px solid #000; border-collapse: collapse" width="100%" >
          <tr>
            <td align="center"><img src="'.$logo_e.'" width="120px;" border=0></td>        
            <td>
  ...
  <br><br><br><br>
        ...
        <div style="width: 50%; border: 0pt solid #9e9e9e; border-radius:4pt; padding: 0pt; float: right;">
          ...
          <table border=0 style="border: 0px solid #000;" width="100%" >
            ...
            <tr>
              ...
              <td   width="60%" style="color: #000000" ><p style="font-size:10px; text-align:center"><font style="font-size:10px;"></font>'.$UUID_origen.'</p></td>
            ...
            <tr>
               ...
               <td  width="60%"  style="color: #000000"><p style="font-size:10px; text-align:left"><font style="font-size:10px; "></font>'.$noCertificado_origen.'</p></td>
            </tr>
            ...
            <tr>
              ...
              <td width="60%" style="color: #000000"><p style="font-size:10px; text-align:center"><font style="font-size:10px;"></font>'.$noCertificadoSAT_origen.'</p></td>              
            </tr>  
             <tr>
    ...
    <div style="width: 100%;  border-bottom: 3px solid #ccc;">
       <div style="width: 49%; border: 1px solid #ccc; border-radius:2pt; padding: 0pt; float: left;">
         <table style="border: 0px solid #000; border-collapse: collapse" width="100%" >
            <tr style="background-color: #ccc;">
              <td HEIGHT="20" style="border: 0px solid #000000;"><p style="font-size:12px;color:#000000;"><font style="color:#000000"><b style="color:#000000">Datos del Receptor</b></font></p>
              </td>          
            </tr> 
            <tr>
             <td HEIGHT="20"><p style="font-size:12px;"><font style="font-size:12px">
    ...
    <div style="width: 100%; border: 1px solid #ccc; border-radius:2pt; padding: 0pt; "> 
        ...
        <table border=0 style="border: 0px solid #000; border-collapse: collapse" width="100%">
          <tr style="background-color: #ccc;">
            <td HEIGHT="20" width="20%" align="left"  style="font-size:11px;color:#000000; border-bottom: 1px solid #ccc; border-right: 1px solid #ccc;"><center><b style="color:#000000">Fecha Pago</b></center></td>
            <td HEIGHT="20" width="40%" align="left"  style="font-size:11px;color:#000000; border-bottom: 1px solid #ccc; border-right: 1px solid #ccc;"><b style="color:#000000">Forma de Pago</b></td>
            <td HEIGHT="20" width="20%" align="left"  style="font-size:11px;color:#000000; border-bottom: 1px solid #ccc; border-right: 1px solid #ccc;" ><center><b style="color:#000000">Moneda</b></center>
            <td HEIGHT="20" width="20%" align="left"  style="font-size:11px;color:#000000; border-bottom: 1px solid #ccc; border-right: 1px solid #ccc;" ><center><b style="color:#000000">Total del Pago</b></center>
            </td>
          </tr>
          <tr><td>
          ...
          <tr><td HEIGHT="20" colspan="4" style="font-size:12px;color:#000000; border: 1px solid #ccc; "></td></tr>
          <tr>
        ...
        <table border=0 style="border: 0px solid #000; border-collapse: collapse" width="100%">
          <tr style="background-color: #ccc;">
            ...
            <td HEIGHT="20"  align="left"  style="font-size:11px;color:#000000; border-bottom: 1px solid #ccc; border-right: 1px solid #ccc;" ><center><b style="color:#000000">Importe Pendiente</b></center>
             <td HEIGHT="20"  align="left"  style="font-size:11px;color:#000000; border-bottom: 1px solid #ccc; border-right: 1px solid #ccc;" ><center><b style="color:#000000">Monto Pagado</b></center>
            </td>
          </tr>
          <tr>
          '.$html_desc_debe.'
    ...
    <br>
     ...
     $qr = ' <div style="width: 100%;">
       <table width="100%">
        <tr>
         <td width="40%" style="position: fixed;">'.$ImgQR.'</td>
         <td width="60%" style="position: fixed;">
          <p style="font-size:22px;"><b>Cadena original del complemento de certificación digital del SAT:</b></p>
          <p style="font-size:22px;">||'.$tfd_version_origen.'|'.$UUID_origen.'|'.$FechaTimbrado_origen.'|<br>'.substr($selloCFD_origen,0,120).'<br>'.substr($selloCFD_origen,120,120).'<br>'.substr($selloCFD_origen,240,strlen($selloCFD_origen)).'|'.$noCertificadoSAT_origen.'||</p>
          <br>
          <p style="font-size:22px;"><b>Sello digital del Emisor:</b></p>
          <p style="font-size:22px;">'.substr($selloCFD_origen,0,120).'<br>'.substr($selloCFD_origen,120,120).'<br>'.substr($selloCFD_origen,240,strlen($selloCFD_origen)).'</p>
          <br>
          <p style="font-size:22px;"><b>Sello digital del SAT:</b></p>
          <p style="font-size:22px;">'.substr($selloSAT_origen,0,120).'<br>'.substr($selloSAT_origen,120,120).'<br>'.substr($selloSAT_origen,240,strlen($selloSAT_origen)).'</p>
         </td>
        </tr>
      </table></div>';
...
// $mpdf->Output();
$mpdf->Output("../comprobantesPago/".$uuid_factura.".pdf");
